    ...
    <div>
      ...
      <div className="container max-w-4xl mx-auto mt-18 pb-12">
        <div className="text-center my-20">
          <h1 className="text-5xl font-bold text-gray-200 mb-10">Contact Us</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card className="bg-zinc-900 border-zinc-800">
            <CardContent className="flex items-start gap-4 p-6">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="font-bold text-xl text-gray-200 mb-2">Leonardo Bessa - CTO</h3>
                <div className="space-y-2">
                  <a 
                    href="https://www.linkedin.com/in/leonardofrancabessa/" 
                    className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a 
                    href="https://wa.me/5598984190129" 
                    className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a 
                    href="mailto:leofranca016@gmail.com" 
                    className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                    leofranca016@gmail.com
                  </a>
                </div>
              </div>
            </CardContent>
