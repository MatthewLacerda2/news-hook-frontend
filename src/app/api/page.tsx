...
export default function APIPage() {
  return (
    <div>
      <div className="container max-w-3xl mx-auto mt-16 px-4 sm:px-6">
        <div className="mb-8 text-sm text-gray-200 font-bold leading-relaxed">
          ...
          <p className="break-all">Docs: <a href={BASE_PATH + "/docs"} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">{shortner_path + "/docs"}</a></p>
          <p className="text-gray-300 font-semibold">X-API-Key header is required</p>
        </div>
        <EndpointCard
          url="/alerts"
